 ...
 */
package com.themobileknowledge.uwbconnectapp.screens.tracker.arcore.utils;
...
public class Texture implements Closeable {
     ...
     * mostly only useful for creating textures. See {@link #createFromAsset}
     * if you want a texture with data.
     */
